...
m = MiniMindForCausalLM.from_pretrained("minimind_v2_pure", trust_remote_code=True, torch_dtype=torch.float16)
t = AutoTokenizer.from_pretrained("minimind_v2_pure", trust_remote_code=True)
m.to("cuda"); m.eval()
